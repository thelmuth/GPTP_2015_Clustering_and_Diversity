...
\section{Explorating Population Dynamics}
\label{sec:exploration}

The key goal of this paper is to try to better understand why lexicase outperforms tournament selection
and implicit fitness sharing (IFS) on a variety of problems. One hypothesis is that lexicase helps maintain population diversity
...
ways, and concentrate on how individuals cluster based on the cases where they perform well.
...
of successes, i.e., runs where a program was evolved with total error of 0 across all the training cases, as well as generalizing to an unseen test set.
